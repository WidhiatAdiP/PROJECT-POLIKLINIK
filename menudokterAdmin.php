      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
            <li class="nav-item">
              <a href="daftarpoliAdmin.php" class="nav-link">
                <i class="nav-icon fas fa-table"></i>
                <p>
                  Poli
                </p>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Halaman Dokter Admin</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          ...
          if (isset($_GET['page'])) {
            ...
            if ($_GET['page'] === 'login') {
              ...
              include("loginAdmin.php");
            } elseif ($_GET['page'] === 'dokter') {
              // Include menuDokter.php for the 'dokter' page
              include("menuDokter.php");
            } else {
            ...
            include("menuDokter.php"); // Change "defaultContent.php" to the default content file you want to include
          }
          ?>
        </div><!-- /.container-fluid -->
      </div>
